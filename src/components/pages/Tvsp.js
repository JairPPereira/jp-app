...
export default function TVsp() {
  ...
  return (
    ...
    <center>
      ...
      <Card.Img variant="top" src="https://www.lance.com.br/files/article_main/uploads/2021/11/14/619146924380d.png" />
      <Card.Body>
        <Card.Title>ESPN 3</Card.Title>
        <Card.Text><p2>ESPN, sigla para Entertainment and Sports Programming Network, é uma família de canais de TV por assinatura dos Estados Unidos dedicada à transmissão e produção de programas esportivos 24 horas por dia.</p2>
        </Card.Text>
        <Link to="./Espn3"><Button variant="primary" size="lg" width="100%">
      Assistir
        </Button></Link>
      </Card.Body>
    </Card></center>
    ...
    <center>
      ...
      <Card.Img variant="top" src="https://static.cdn.pleno.news/2020/05/size_960_16_9_premiere.jpeg" />
      <Card.Body>
        <Card.Title>Premiere 3</Card.Title>
        <Card.Text><p2>O Premiere é um canal de televisão por assinatura brasileiro que utiliza o formato Pay-Per-View para exibir os jogos do Campeonato Brasileiro Séries A e B, Copa do Brasil e alguns Campeonatos Estaduais dos quais o Grupo Globo ainda possui os direitos de transmissão.</p2>
        </Card.Text>
        <Link to="./Premiere3"><Button variant="primary" size="lg" width="100%">
      Assistir
        </Button></Link>
      </Card.Body>
    </Card></center>
    ...
    <center>
      ...
      <Card.Body>
        <Card.Title>TNT Sports 1</Card.Title>
    ...
    <center>
      ...
      <Card.Img variant="top" src="https://i.superesportes.com.br/fImaHSt3kdLkaKCufzi2rcGF730=/smart/imgsapp.mg.superesportes.com.br/app/noticia_126420360808/2021/01/17/3886702/20210117115713856710u.jpg" />
      <Card.Body>
        <Card.Title>TNT Sports 5</Card.Title>
        <Card.Text><p2>No portal do TNT Sports você vê todas as notícias e melhores momentos da Champions League, Brasileirão, Nations League e muito mais!</p2>
        </Card.Text>
        <Link to="./Tntsports5"><Button variant="primary" size="lg" width="100%">
      Assistir
        </Button></Link>
      </Card.Body>
    </Card></center>
    ...
    <center>
      ...
      <Card.Img variant="top" src="https://i.superesportes.com.br/fImaHSt3kdLkaKCufzi2rcGF730=/smart/imgsapp.mg.superesportes.com.br/app/noticia_126420360808/2021/01/17/3886702/20210117115713856710u.jpg" />
      <Card.Body>
        <Card.Title>TNT Sports 7</Card.Title>
        <Card.Text><p2>No portal do TNT Sports você vê todas as notícias e melhores momentos da Champions League, Brasileirão, Nations League e muito mais!</p2>
        </Card.Text>
        <Link to="./Tntsports7"><Button variant="primary" size="lg" width="100%">
      Assistir
        </Button></Link>
      </Card.Body>
    </Card></center>
    ...
    <center>
      ...
      <Card.Img variant="top" src="https://i.superesportes.com.br/fImaHSt3kdLkaKCufzi2rcGF730=/smart/imgsapp.mg.superesportes.com.br/app/noticia_126420360808/2021/01/17/3886702/20210117115713856710u.jpg" />
      <Card.Body>
        <Card.Title>TNT Sports 8</Card.Title>
        <Card.Text><p2>No portal do TNT Sports você vê todas as notícias e melhores momentos da Champions League, Brasileirão, Nations League e muito mais!</p2>
        </Card.Text>
